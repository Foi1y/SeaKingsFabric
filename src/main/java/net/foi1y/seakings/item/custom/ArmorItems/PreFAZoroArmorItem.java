...
import net.foi1y.seakings.entity.client.armor.Renders.ZoroArmorRenderer;
...
public final class PreFAZoroArmorItem extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private final Supplier<Object> renderProvider = GeoItem.makeRenderer(this);

    public PreFAZoroArmorItem(ArmorMaterial armorMaterial, ArmorItem.Type type, Settings properties){
