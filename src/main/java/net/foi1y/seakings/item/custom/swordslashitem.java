...
import net.foi1y.seakings.entity.custom.SwordSlashGreenProjectileEntity;
...
public class swordslashitem extends Item {
    public swordslashitem(Settings settings) {
        super(settings);
    }
    @Override
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            SwordSlashGreenProjectileEntity snowballEntity = new SwordSlashGreenProjectileEntity(user, world);
